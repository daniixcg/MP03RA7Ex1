...
export class PokemonTeamViewModel {
  constructor(jsonUrl = "/src/assets/pokemon_data.json"){//pokemonUI 
...
/*    if(this.currentPlayer.name==this.player1.name){
  ...
  getRandomFighter(team) {
    ...
    this.getWhoIsFighting(team.selectedTeam[randomIndex].fight())
  ...
  getWhoIsFighting(player){
    switch(player){
      case "Player1":
        let whoIsFighting1 = this.player1.getWhoIsFighting();
        console.log(whoIsFighting1);
        return whoIsFighting1;
      case "Player2":
        let whoIsFighting2 = this.player2.getWhoIsFighting();
        console.log(whoIsFighting2);
        return whoIsFighting2;
    }
  }
